...
class ClientsAreSaying extends Component {
  constructor(props) {
    super(props);
    this.state = {
      rating: 3
        ...
        <MDBRow>
          ...
          >
            <div style={{ height: "100%" }}>
              ...
              >
                ...
                >
                  Finding reliable & affordable tutor/study coach can be hard
                  but Gradegetter make it easier. <br /><br/>
                  All our tutors are background checked, screen, interviewed and
                  verified by our hiring team
                </p>
                <br />
                <img
                  style={{
          ...
          <MDBCol xl="8" l="8" md="8" sm="12" xs="12">
            <div className="logoSecond">
              ...
              <p className="emailTXT"> Clients Are Saying</p>
            </div>
            ...
            <div style={{ width:'95%', marginLeft: "11%" }}>
              <MDBRow>
